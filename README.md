...
**5. PlayFair**
  ...
  - Thuật toán:
      ...
      + Với digraph (a,b):  
            ...
            <brNếu cùng cột → thay bằng chữ bên dưới (mã hóa) / trên (giải mã).
            <brNếu khác hàng/cột → thay bằng 2 chữ ở hàng tương ứng và cột giao nhau (hình chữ nhật): a -> (row_a, col_b), b -> (row_b, col_a).
